...
$expectedRepoRoot = "E:\bzclaw-side"
...
if ($originUrl -eq $legacyMirrorOrigin) {
    Write-Host "origin currently points to the local legacy mirror. Repairing it to GitHub..."
...
if ($StageAll) {
    Write-Host "Staging all repo-visible changes..."
